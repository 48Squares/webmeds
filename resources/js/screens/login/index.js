      ...
      <div className="bg-regal-blue">
        <div className=" w-screen px-4 py-4">
          <div className="flex justify-start py-4">
            <a href="/">
              <button
                className="inline-block mr-28 focus:outline-none"
          ...
          <div>
            <form action="" className="">
              ...
              <div className="absolute bottom-4 left-0 flex w-full justify-center px-4">
                <button className="bg-regal-blue px-4 py-3 focus:ring hover:ring rounded-sm text-white w-full focus:outline-none">
                  Send OTP
                </button>
              </div>
            </form>
